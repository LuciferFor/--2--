...
function isAllowedD2Path(path: string): boolean {
  return [
    ...
    /^\/api\/d2\/loadouts\/qq\/[^/?#]+$/,
    /^\/api\/d2\/loadouts\/qq\/[^/?#]+\/equip$/,
    /^\/api\/d2\/loadouts\/qq\/[^/?#]+\/snapshot$/,
    /^\/api\/d2\/loadouts\/qq\/[^/?#]+\/update-identifiers$/,
    /^\/api\/d2\/loadouts\/qq\/[^/?#]+\/clear$/,
    /^\/api\/d2\/saved-loadouts\/qq\/[^/?#]+$/,
    /^\/api\/d2\/saved-loadouts\/qq\/[^/?#]+\/[^/?#]+$/,
    /^\/api\/d2\/saved-loadouts\/qq\/[^/?#]+\/[^/?#]+\/apply$/,
    /^\/api\/d2\/loadout-optimizer\/qq\/[^/?#]+\/search$/,
    /^\/api\/d2\/loadout-optimizer\/qq\/[^/?#]+\/apply$/,
    /^\/api\/d2\/catalysts\/[^/?#]+\/[^/?#]+$/,
    /^\/api\/d2\/catalysts\/qq\/[^/?#]+$/,
    /^\/api\/d2\/catalysts\/qq\/[^/?#]+\/item$/,
    /^\/api\/d2\/catalyst-info$/,
    /^\/api\/d2\/item-info$/,
    /^\/api\/d2\/perk-weapons$/,
    /^\/api\/d2\/titles\/[^/?#]+\/[^/?#]+$/,
    /^\/api\/d2\/skins\/[^/?#]+\/[^/?#]+$/,
